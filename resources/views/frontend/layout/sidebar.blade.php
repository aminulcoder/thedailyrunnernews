    ...
    <div class="rightSideBar">
        <div class="survey-area my-1">
            <div class="card">
                ...
                <div class="card-body">
                    {{-- <iframe width="100%" height="auto" src="{!! $intro !!}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> --}}
                    {!! $intro !!}
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="">
                                    <div class="col-md-12">
                                        <img src="{{ asset('frontend/asset/img/epaper img 1.png') }}"
                                            style="width:100%" alt="">
                                    </div>
                                </a>
